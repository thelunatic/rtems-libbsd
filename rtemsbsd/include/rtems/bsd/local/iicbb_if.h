...
static __inline int IICBB_CALLBACK(device_t dev, int index, caddr_t data)
{
	...
	rc = ((iicbb_callback_t *) _m)(dev, index, data);
	return (rc);
}
                                ...
                                u_char *oldaddr)
{
	...
	rc = ((iicbb_reset_t *) _m)(dev, speed, addr, oldaddr);
	return (rc);
}
